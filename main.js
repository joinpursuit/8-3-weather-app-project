...
//     console.log(`https://wttr.in/${event.target.location.value}?format=j1`)
//     fetch (`https://wttr.in/${event.target.location.value}?format=j1`).then(result => {
//         console.log ('Fetch was successful')
//         return result.json()
//     }).then(weather =>{
//    //  console.log (weather. "Finally properly")
//      console.log (weather.current_condition[0].FeelsLikeF)
//     })
    
// });  This was a tester to ensure the api was fetched now save that to a variable 
...
// line 3 decoded; document.querySelects literaly selects an area on the webpage
// when we addEventListner we are literally saying, hey, we are waiting for an event 
// to occurr.  In this scenario, the event is a submit, we input an event.preventdefault
//and invoke it because we need to prevent refresh
// we do event.target to listen specifically 
