...
document.querySelector("form").addEventListener("submit", (event) => {
    ...
    fetch(`https://wttr.in/${event.target.location.value}?format=j1`).
        then(result => {
            ...
            spFakeLink.addEventListener('click', () => {
                document.querySelector("main").innerHTML = document.getElementById("fakeMain").innerHTML;
            ...
            //lemme try copying the whole article html

            // const spStorageInput = locationStorage;
            // const spStorageNearestArea
            // const spStorageRegion
            // const spStorageCountry
            // const spStorageCurrentlyFeelsF
            // const spStorageChanceSunshine
            // const spStorageChanceRain
            // const spStorageChanceSnow
