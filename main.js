...
document.querySelector("form").addEventListener("submit", (event) => {
    ...
    pToday.innerHTML =
    `<span class="today"><strong>Average Temperature:</strong> ${weather.weather[0].avgtempF} &#8457</span>
    <br>
    ...
    tomorrow.innerHTML = `<h1>Tomorrow</h1>`
    ...
    day.innerHTML = `<h1>Day After Tomorrow</h1>`
